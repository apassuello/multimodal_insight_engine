...
def test_dataloader_initialization(temp_data_dir):
    ...
    dataloader = WMTDataLoader(
        data_dir=temp_data_dir, source_lang="en", target_lang="fr", batch_size=2
    )
...
def test_load_data(temp_data_dir, sample_data):
    ...
    dataloader = WMTDataLoader(
        data_dir=temp_data_dir, source_lang="en", target_lang="fr", shuffle=False
    )
...
def test_max_examples(temp_data_dir):
    ...
    dataloader = WMTDataLoader(
        data_dir=temp_data_dir, source_lang="en", target_lang="fr", max_examples=3
    )
...
def test_file_not_found(tmp_path):
    ...
    with pytest.raises(FileNotFoundError):
        WMTDataLoader(data_dir=str(tmp_path), source_lang="en", target_lang="fr")
...
def test_different_length_files(tmp_path):
    ...
    dataloader = WMTDataLoader(data_dir=str(data_dir), source_lang="en", target_lang="fr")
...
def test_seed_reproducibility(temp_data_dir):
    ...
    dataloader1 = WMTDataLoader(data_dir=temp_data_dir, source_lang="en", target_lang="fr", seed=42)

    dataloader2 = WMTDataLoader(data_dir=temp_data_dir, source_lang="en", target_lang="fr", seed=42)
