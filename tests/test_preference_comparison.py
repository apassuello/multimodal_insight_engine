    ...
    def test_generate_preference_pairs_multiple_prompts(self):
        ...
        with patch("src.safety.constitutional.model_utils.generate_text") as mock_gen:
            ...
            mock_gen.side_effect = [
                "R1",
                "R2",
                "A is better",  # Prompt 1
                "R3",
                "R4",
                "B is better",  # Prompt 2
            ]
    ...
    def test_generate_preference_pairs_handles_errors(self):
        ...
        with patch("src.safety.constitutional.model_utils.generate_text") as mock_gen:
            ...
            mock_gen.side_effect = [
                "R1",
                "R2",
                "A is better",  # Prompt 1 - success
                "R3",
                "R4",
                Exception("Model error"),  # Prompt 2 - fails
                "R5",
                "R6",
                "B is better",  # Prompt 3 - success
            ]
        ...
        data = [
            {
                ...
                "comparison_reasoning": "X",
            },
            {
                "prompt": "P2",
                "response_chosen": "C2",
                "response_rejected": "R2",
                "comparison_reasoning": "Y",
            },
            {
                "prompt": "P3",
                "response_chosen": "C3",
