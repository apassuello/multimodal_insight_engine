...
def create_test_data(temp_dir: str, src_lang: str = "de", tgt_lang: str = "en"):
    ...
    src_data = ["Das ist ein Test.", "Wie geht es dir?", "Guten Morgen!", "Auf Wiedersehen!"]
    tgt_data = ["This is a test.", "How are you?", "Good morning!", "Goodbye!"]
...
def test_europarl_dataset_loading():
    ...
    with TemporaryDirectory() as temp_dir:
        ...
        dataset = EuroparlDataset(data_dir=temp_dir, src_lang="de", tgt_lang="en")
...
def test_europarl_dataset_max_examples():
    ...
    with TemporaryDirectory() as temp_dir:
        ...
        dataset = EuroparlDataset(data_dir=temp_dir, max_examples=2)
