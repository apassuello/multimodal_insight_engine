...
from src.models.feed_forward import FeedForwardClassifier, FeedForwardNN, MultiLayerPerceptron
...
def test_feed_forward_classifier_training_step(
    ff_classifier, batch_size, input_size, output_size, device
):
...
def test_feed_forward_classifier_validation_step(
    ff_classifier, batch_size, input_size, output_size, device
):
